...
type EditArticle = {
    procedure: STORED_PROCEDURES.EDIT_ARTICLE,
...
type ApproveArticle = {
    procedure: STORED_PROCEDURES.APPROVE_ARTICLE,
    values: [number]
}
...
type DeleteArticleComponent = {
    procedure: STORED_PROCEDURES.DELETE_ARTICLE_COMPONENT,
    values: [number]
};
